...
<body>
    ...
    <div class="server-panel">
        ...
        <div class="server-item">
            <img src="https://cdn.discordapp.com/icons/1226406024207011900/e65b7617f303623d64f952c903775be0.webp"
                alt="RazerCraft" class="server-avatar">
        </div>
        ...
        <div class="user-panel">
            ...
            <div class="user-controls">
                ...
                <button class="control-btn" title="Micrófono">
                    <img class="microfono"
                        src="https://raw.githubusercontent.com/cubysot/razerbot/refs/heads/main/assets/microphone.svg"
                        alt="Micrófono">
                </button>
                <!-- Botón de auriculares -->
                <button class="control-btn" title="Auriculares">
                    <img class="audifonos"
                        src="https://raw.githubusercontent.com/cubysot/razerbot/refs/heads/main/assets/headphone.svg"
                        alt="Auricolares">
                </button>
                <!-- Botón de ajustes -->
                <button class="control-btn" title="Ajustes">
                    <img class="ajustes"
                        src="https://raw.githubusercontent.com/cubysot/razerbot/refs/heads/main/assets/settings.svg"
                        alt="Ajustes">
                </button>
            </div>
        </div>
    ...
    if (att.contentType?.startsWith('image/')) {
      ...
      return `<a href="${att.url}" download="${att.name}" class="download-link">Descargar archivo:
                            ${att.name}</a>`;
    }
  }).join('')}
                    </div>` : ''}
